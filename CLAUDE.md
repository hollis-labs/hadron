...
1. Read `.volon/agent-boot.md` — core rules and reference map
2. Read `.volon/bootstrap.md` — current iteration state
...
- **Follow conventions**: See `.volon/pcc/global/02_conventions.md`
...
| File | Purpose |
|------|---------|
| `volon.yaml` | Project configuration |
| `.volon/bootstrap.md` | Current iteration state |
| `.volon/agent-boot.md` | Core rules + reference map |
| `.volon/pcc/global/` | Project context cache |
| `.volon/tasks/` | Task files |
